...
$CONFIG['chatroom_title'] = 'Avatar Chat';
$CONFIG['chatroom_url'] = 'http://yoursite.com/avatarchat/';
$CONFIG['admin_email'] = 'admin@yoursite.com';

// Control Panel Login Details

$CONFIG['admin_name'] = 'admin'; // admin username
$CONFIG['admin_pass'] = 'adminpass'; // admin password
$CONFIG['mods_pass'] = 'modpass'; // moderators password

// Chat Room Moderators (array)
// use lowercase characters only eg. bob not Bob

$chatroom_mods=array("admin", "mod", "etc");
...
$CONFIG['credits_package'] = '100'; // credits
$CONFIG['credits_cost'] = '10'; // cost per xxx credits (see above)
$CONFIG['credits_free_signup'] = '10'; // free credits on signup
$CONFIG['credits_free_login_min'] = '1'; // free credits per daily login (min)
$CONFIG['credits_free_login_max'] = '5'; // free credits per daily login (max)

// Reward Credits
// these are free credits awarded for user actions

$CONFIG['reward_profile'] = '3'; // credits (each profile viewed)
$CONFIG['reward_heart'] = '1'; // credits (each heart sent)
...
$CONFIG['remoteMusic'] = '0'; // allow users to link to remote music streams - 0 No, 1 Yes
...
$CONFIG['avatar_female'] = '2|avatars/female/base/whiteFemaleBody.png|avatars/female/bottoms/lightFlowerJeans.png|avatars/female/eyes/blueFemaleEyes.png|avatars/female/hair/blondePonytail.png|avatars/nopic.png|avatars/female/mouth/femaleSmile.png|avatars/female/shoes/pinkSandals.png|avatars/female/tops/loveTee.png|avatars/nopic.png';
