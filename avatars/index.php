...
<div id="menu">
	...
	<span class="menu" style="top:230px;left:25px;" onclick="randomAvatar()"><div class="menutext">Randomize</div></span>
	<span class="menu" style="top:255px;left:25px;" onclick="showItems('base')"><div class="menutext">Body</div></span>
	<span class="menu" style="top:280px;left:25px;" onclick="showItems('bottoms')"><div class="menutext">Bottoms</div></span>
	<span class="menu" style="top:305px;left:25px;" onclick="showItems('eyes')"><div class="menutext">Eyes</div></span>
	<span class="menu" style="top:330px;left:25px;" onclick="showItems('hair')"><div class="menutext">Hair</div></span>
	<span class="menu" style="top:355px;left:25px;" onclick="showItems('beard')"><div class="menutext">Beards</div></span>
	<span class="menu" style="top:380px;left:25px;" onclick="showItems('mouth')"><div class="menutext">Mouth</div></span>
	<span class="menu" style="top:405px;left:25px;" onclick="showItems('shoes')"><div class="menutext">Shoes</div></span>
	<span class="menu" style="top:430px;left:25px;" onclick="showItems('tops')"><div class="menutext">Tops</div></span>
	<span class="menu" style="top:455px;left:25px;" onclick="showItems('accessories')"><div class="menutext">Accessories</div></span>
