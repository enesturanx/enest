...
?>
	...
	<b>:: <a href="index.php"><?php echo $CONFIG['chatroom_title'];?> - Virtual Shop</a></b>

	<?php

	if($_SESSION['username'])
	{
		echo '[<a href="account.php">Go to My Account</a>]&nbsp;[<a href="account.php?transfer=1">Transfer Credits</a>]';
	}
	...
	if($_SESSION['username'])
	{
		...
		$shopWelcome = 'Welcome '.$_SESSION['username'].', you have <b>'.$_SESSION['userCredits'].'</b> Credits</b> [<a href="credits.php">Buy More</a>]';
	}
	else
	{
		$shopWelcome = 'Welcome Guest, please [<a href="../index.php">login</a>] to purchase items.';
	}
	...
	Search Shop Items: <input type="text" name="search_item"><input type="submit" name="submit" value="Go!">
	</form>
	...
	else
	{
		...
		do { 
			...
			echo "[<a href='index.php?purchase=1&itemID=".$row['id']."&cost=".$row['cost']."&r=".$r."&search_item=".$_REQUEST['search_item']."'>Buy Now</a>]"; 
			echo "<br><br></td>";
	...
	if($last >= 0){
		...
		echo "<a href='index.php?search_item=".$_REQUEST['search_item']."&r=".$last."'><< Last</a>";
	}
	...
	if($next < $num_rows){
		...
		echo "<a href='index.php?search_item=".$_REQUEST['search_item']."&r=".$next."'>Next >></a>";
	}
