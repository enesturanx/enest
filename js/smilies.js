...
**/
	...
	function convertSmilies(nSmilie){
		...
		nSmilie = nSmilie.replace(":7","_s4_");
		nSmilie = nSmilie.replace(";(","_s5_");
		nSmilie = nSmilie.replace(":(","_s6_");
		nSmilie = nSmilie.replace(":V","_s7_");
		...
		nSmilie = nSmilie.replace("*D","_s13_");
	...
	function addSmilies(nSmilie){
		...
		nSmilie = nSmilie.replace(/_s4_/gi,"<img style='vertical-align:middle;' src='smilies/blush.gif'> ");
		nSmilie = nSmilie.replace(/_s5_/gi,"<img style='vertical-align:middle;' src='smilies/cry.gif'> ");
		nSmilie = nSmilie.replace(/_s6_/gi,"<img style='vertical-align:middle;' src='smilies/sadley.gif'> ");
		nSmilie = nSmilie.replace(/_s7_/gi,"<img style='vertical-align:middle;' src='smilies/confused.gif'> ");
		...
		nSmilie = nSmilie.replace(/_s13_/gi,"<img style='vertical-align:middle;' src='smilies/shiny.gif'> ");
