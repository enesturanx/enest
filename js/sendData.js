...
function sendVote(vAction, vID, vtoUser) {
	...
	//format vote message
	if(vAction=='love'){vMessage = " sent a heart.png to ";voteID = 1;}
	if(vAction=='like'){vMessage = " sent a thumbs_up.png to ";voteID = 2;}
	if(vAction=='star'){vMessage = " sent a star.png to ";voteID = 3;}
		...
		if (gPTSReq.readyState == 4) {
			...
			for (i = 0; i < n_votes; i++) {
				...
				if(user_points[0].firstChild.nodeValue == 1){
					...
					document.getElementById('sysmess').innerHTML = "You have already voted!";
					...
					//show system message
					document.getElementById('sysmess').style.visibility='visible';
					document.getElementById('sysmess').innerHTML = "Thanks For Voting!";
...
function sendUserMail() {
		...
		//show system message
		document.getElementById('sysmess').style.visibility='visible';
		document.getElementById('sysmess').innerHTML = "Your Message Has Been Sent!";
