...
**/
	...
	function showUsers(dUid,dUserid, dUname,dAvatar,dAvatarx,dAvatary,dWebcam,dOffline,dlove,dlike,dstar,dGuest,dAdmin,dVip){
		...
		if(dOffline < '1'){
			...
			if(!document.getElementById(dUid)){
				...
				newdiv.innerHTML += "<div id='"+dUid+"myAvatar' class='myAvatar' style='top: "+dAvatary+"px; left: "+dAvatarx+"px; position:absolute; width:70px; height:140px; cursor:pointer;'><center><span style='cursor:pointer;' onclick=showUserDetails('"+dUid+"','"+dUname+"','"+dAvatary+"','"+dAvatarx+"','"+dAdmin+"');><b>"+isSTATUS+"</b></span><br><span class=\"span\"><img id=\"base\" src=\""+dAvatar[1]+"\" height=\"140\" width=\"70\"></span><span class=\"span\"><img id=\"bottoms\" src=\""+dAvatar[2]+"\" height=\"140\" width=\"70\"></span><span class=\"span\"><img id=\"eyes\" src=\""+dAvatar[3]+"\" height=\"140\" width=\"70\"></span><span class=\"span\"><img id=\"hair\" src=\""+dAvatar[4]+"\" height=\"140\" width=\"70\"></span><span class=\"span\"><img id=\"beard\" src=\""+dAvatar[5]+"\" height=\"140\" width=\"70\"></span><span class=\"span\"><img id=\"mouth\" src=\""+dAvatar[6]+"\" height=\"140\" width=\"70\"></span><span class=\"span\"><img id=\"shoes\" src=\""+dAvatar[7]+"\" height=\"140\" width=\"70\"></span><span class=\"span\"><img id=\"tops\" src=\""+dAvatar[8]+"\" height=\"140\" width=\"70\"></span><span class=\"span\"><img id=\"accessories\" src=\""+dAvatar[9]+"\" height=\"140\" width=\"70\"></span><span class=\"span\"><img id=\"trans\" src=\"avatars/nopic.png\" height=\"140\" width=\"70\" onclick=showUserDetails('"+dUid+"','"+dUname+"','"+dAvatary+"','"+dAvatarx+"','"+dAdmin+"');></span></center></div>";
	...
	function showUserDetails(dUid,dUser,dY,dX,dAdmin){
		...
		//add data
		document.getElementById('userdetails').innerHTML  = "<span class='userinfo' onClick=\"toggleBox('userdetails')\">Name: "+dUser+" [x]</span><br>";
		document.getElementById('userdetails').innerHTML += "<span class='userinfo' onClick=\"sendVote('love', '"+dUid+"','"+dUser+"');toggleBox('userdetails');\"><img id='love' style='cursor:pointer;vertical-align:middle;padding-top:4px;' src=images/heart_add.png><span id='lovepts'>0</b></span></span>&nbsp;";
		document.getElementById('userdetails').innerHTML += "<span class='userinfo' onClick=\"sendVote('like', '"+dUid+"','"+dUser+"');toggleBox('userdetails')\"><img id='thumbsup' style='cursor:pointer;vertical-align:middle;padding-top:4px;' src=images/thumbs_up_add.png><span id='likepts'>0</b></span></span>&nbsp;";
		document.getElementById('userdetails').innerHTML += "<span class='userinfo' onClick=\"sendVote('star', '"+dUid+"','"+dUser+"');toggleBox('userdetails')\"><img id='star' style='cursor:pointer;vertical-align:middle;padding-top:4px;' src=images/star_add.png><span id='starpts'>0</b></span></span>&nbsp;<br>";

		//assign profile url
		if(chatProfileID == '0'){

			var userProfileUrl = chatProfileUrl+dUser;
		...
		if(chatMemberLevel == 1){
			...
			document.getElementById('userdetails').innerHTML += "<span class='userinfo' onClick=\"doWhisper('"+dUser+"')\"><img id='pchat' style='cursor:pointer;vertical-align:middle;padding-top:4px;' src=images/private_chat.png> Private Chat</span></br>";

		}else{

			document.getElementById('userdetails').innerHTML += "<span class='userinfo' onClick=\"grayOut(true);showVIP();\"><img id='pchat' style='cursor:pointer;vertical-align:middle;padding-top:4px;' src=images/private_chat.png> Private Chat</span></br>";

		}

		document.getElementById('userdetails').innerHTML += "<span class='userinfo' onClick=\"toggleBox('userdetails');reqFriend('"+dUid+"','"+dUser+"')\"><img id='useradd' style='cursor:pointer;vertical-align:middle;padding-top:4px;' src=images/user_add.png> Add to Friends</span></br>";

		document.getElementById('userdetails').innerHTML += "<span class='userinfo' onClick=\"toggleBox('userdetails');showInteractionWindow('"+dUser+"');\"><img id='useradd' style='cursor:pointer;vertical-align:middle;padding-top:4px;' src=images/iaction.png> Send Interaction</span></br>";

		// check if user is trying to block room owner
		var getThisUserID = "-"+dUid.replace(/_/gi,"");

		if(getThisUserID == room || dAdmin > 0){

			document.getElementById('userdetails').innerHTML += "<span class='userinfo' onClick=\"alert('you cannot block admins or room owners')\"><img id='block' style='vertical-align:middle;padding-top:4px;' src=images/block.png> Block User</span>";

		}else{

			document.getElementById('userdetails').innerHTML += "<span class='userinfo' onClick=\"blockUser('"+dUid+"','"+dUser+"')\"><img id='block' style='vertical-align:middle;padding-top:4px;' src=images/block.png> Block User</span>";

		}

		if(toWhisper != dUser){

			document.getElementById('pchat').src="images/private_chat.png";
		...
		// get the existing avatar div pos
		dest_x = document.getElementById("_a_myAvatar").offsetLeft; // x axis
		dest_y = document.getElementById("_a_myAvatar").offsetTop; // y axis

		toggleBox('userdetails');
